...
2017-08-20 [MySQL](https://draveness.me/tags/mysql) [PostgreSQL](https://draveness.me/tags/postgresql) [数据库](https://draveness.me/tags/数据库)
...
![Transaction-Basics](image/2017-08-20-Transaction-Basics.jpg-1000width)
...
![Atomic-Operation](image/2017-08-20-Atomic-Operation.jpg-1000width)
...
![Transaction-Undo-Log](image/2017-08-20-Transaction-Undo-Log.jpg-1000width)
...
![Logical-Undo-Log](image/2017-08-20-Logical-Undo-Log.jpg-1000width)
...
![Atomitc-Transaction-State](image/2017-08-20-Atomitc-Transaction-State.jpg-1000width)

但是如果放大来看，我们会发现事务不再是原子的，其中包括了很多中间状态，比如部分提交，事务的状态图也变得越来越复杂。

![Nonatomitc-Transaction-State](image/2017-08-20-Nonatomitc-Transaction-State.jpg-1000width)
...
![Shutdown-After-Commited](image/2017-08-20-Shutdown-After-Commited.jpg-1000width)
...
![Nonrecoverable-Schedule](image/2017-08-20-Nonrecoverable-Schedule.jpg-1000width)
...
![Recoverable-Schedule](image/2017-08-20-Recoverable-Schedule.jpg-1000width)

然而这样还不算完，当事务的数量逐渐增多时，整个恢复流程也会变得越来越复杂，如果我们想要从事务发生的错误中恢复，也不是一件那么容易的事情。

![Cascading-Rollback](image/2017-08-20-Cascading-Rollback.jpg-1000width)
...
![Compensating-Transaction](image/2017-08-20-Compensating-Transaction.jpg-1000width)
...
![Redo-Logging](image/2019-02-21-Redo-Logging.jpg)
...
![Transaction-Log](image/2017-08-20-Transaction-Log.jpg-1000width)
...
![Reasons-for-Allowing-Concurrency](image/2017-08-20-Reasons-for-Allowing-Concurrency.jpg-1000width)
...
![Isolation-Performance](image/2017-08-20-Isolation-Performance.jpg-1000width)
