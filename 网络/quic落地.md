...
我之前写过一篇介绍 HTTP3 的文章：[看 B 站，可以更快！](http://mp.weixin.qq.com/s?__biz=MzUxODAzNDg4NQ==&mid=2247488924&idx=1&sn=d871ce0de68733b4673343aa2f4050f2&chksm=f98e5136cef9d820247cc40aa387f9c8dafc4d21f871ebf6235b93a43f851404b9a6280e3280&scene=21#wechat_redirect)



HTTP3协议最牛逼的地方在于，将传输层的 TCP 替换成 UDP，而且还在 UDP 之上实现了可靠传输的 QUIC 协议。



![图片](image/640-1639195012127479.webp)



大家面试时如果被问到 UDP 如何实现可靠传输，就可以把 QUIC 协议的实现说出来，妥妥稳的。



这几天看到一篇蚂蚁集团实战 QUIC 的文章，我觉得很不错，特此分享给大家。
...
![图片](image/640-1639195012127480.webp)
...
![图片](image/640-1639195012127481.webp)
...
![图片](image/640-1639195012127482.webp)
...
![图片](image/640-1639195012127483.webp)
...
![图片](image/640-1639195012127484.webp)
...
1. 1. Backup 模式，即在 TCP 链路无法使用的情况下，降级到 QUIC 链路。
...
![图片](image/640-1639195012127485.webp)
...
![图片](image/640-1639195012127486.webp)
...
1. 1. 我们在 QUIC 的 CID 中扩展了一些字段（ServerInfo）用来关联 QUIC Server 的 IP 和 Working Port 信息。
...
1. 1. 无论是否连接迁移，QUIC LB 都可以根据 ServerInfo，将报文转发到正确的进程。
...
![图片](image/640-1639195012127487.webp)
...
![图片](image/640-1639195012127488.webp)
...
![图片](image/640-1639195012127489.webp)
...
![图片](image/640-1639195012127490.webp)
...
![图片](image/640-1639195012128491.webp)
...
![图片](image/640-1639195012128492.webp)
...
![图片](image/640-1639195012128493.webp)
