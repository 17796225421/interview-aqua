...
![TCP是什么](image/155dcfd7385db32260288738478aacc3.webp)TCP是什么
...
![TCP四次挥手](image/cf8e826d3073a3c4b984cd542d0a5e2b.webp)TCP四次挥手
...
![FIN-WAIT-2特别多的原因](image/04db99c1daf59cda9447d30c7df3d309.webp)FIN-WAIT-2特别多的原因
...
![close()触发TCP四次挥手](image/dd70978d3e26560c620c801cabfc2f0a.webp)close()触发TCP四次挥手
...
![shutdown触发的TCP四次挥手](image/b6ee792be3e1c3fae6822547b3a09d05.webp)shutdown触发的TCP四次挥手
...
![img](image/a1b8b6a24f68c47e86b91bdf516275b2-163940127115222.webp)
...
![tcp_sendmsg 逻辑](image/tcp_sendmsg%20%E9%80%BB%E8%BE%91-163940127115224.png)
...
![一直不发第三次挥手的情况](image/a896f9f11af1b0b14a22294be69443ff.webp)一直不发第三次挥手的情况
...
![TCP三次挥手](image/a27cec2d14848ec57dd68765351167b4-163940127115227.webp)TCP三次挥手
...
![TCP三次挥手延迟确认](image/df8db40c834adda1cf3119ecf25663f1.webp)TCP三次挥手延迟确认
...
![TCP两次挥手](image/316bd5614a39f4a1e1c1e1101dce628d.webp)TCP两次挥手
...
![image-20210810093309117](image/5fe17d98b145b460a8e9c80a825985ec.webp)image-20210810093309117

可以看到，**相同的socket，自己连自己的时候，握手是三次的。挥手是两次的。**

![TCP自连接](image/a3cd8d7b35ebd0f00fc41dbe9a6284e8.webp)TCP自连接

上面这张图里，左右都是同一个客户端，把它画成两个是为了方便大家理解状态的迁移。

我们可以拿自连接的握手状态**对比下**正常情况下的TCP三次握手。

![正常情况下的TCP三次握手](image/d19fbc00352b8bb25e38e993f5dccfd5.webp)正常情况下的TCP三次握手
...
![TCP同时打开](image/f60ca28a09b77e24fbe0a28230d8326f.webp)TCP同时打开
...
![img](image/84d90494a1a6e951033413178f83bed8.webp)
...
今天提到的，不管是**两次挥手**，还是**自连接**，或是**TCP同时打开**什么的。
