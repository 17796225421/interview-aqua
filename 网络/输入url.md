...
![图片](image/640-163913855781910.webp)URL 解析
...
![图片](image/640-163913855782011.webp)HTTP 的消息格式
...
![图片](image/640-163913855782012.webp)DNS 树状结构
...
![图片](image/640-163913855782013.webp)域名解析的工作流程
...
![图片](image/640-163913855782014.webp)
...
![图片](image/640-163913855782015.webp)TCP 包头格式
...
![图片](image/640-163913855782116.webp)TCP 三次握手
...
![图片](image/640-163913855782117.webp)TCP 连接状态查看

> TCP 分割数据

如果 HTTP 请求消息比较长，超过了 `MSS` 的长度，这时 TCP 就需要把 HTTP 的数据拆解一块块的数据发送，而不是一次性发送所有数据。

![图片](image/640-163913855782118.webp)MTU 与 MSS
...
![图片](image/640-163913855782119.webp)数据包分割
...
![图片](image/640-163913855782120.webp)TCP 层报文
...
![图片](image/640-163913855782121.webp)IP 包头格式
...
![图片](image/640-163913855782122.webp)路由表

举个例子，根据上面的路由表，我们假设 Web 服务器的目标地址是 `192.168.10.200`。

![图片](image/640-163913855782123.webp)路由规则判断
...
![图片](image/640-163913855782124.webp)IP 层报文
...
![图片](image/640-163913855782125.webp)MAC 包头格式
...
![图片](image/640-163913855782126.webp)ARP 广播
...
![图片](image/640-163913855782127.webp)ARP 缓存内容

> MAC 报文生成

至此，网络包的报文如下图。

![图片](image/640-163913855782128.webp)MAC 层报文
...
![图片](image/640-163913855782129.webp)物理层数据包
...
![图片](image/640-163913855782130.webp)交换机的 MAC 地址表
...
![图片](image/640-163913855782131.webp)路由器转发
...
![图片](image/640-163913855782232.webp)
...
![图片](image/640-163913855782233.webp)